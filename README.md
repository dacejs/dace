...
* node: 用 `babel-plugin-syntax-import-async-component-sync` 插件，解决 node 中报错的问题。
...
```
npm i babel-plugin-syntax-dynamic-import babel-plugin-syntax-import-async-component-sync
```
...
npm i react-router-config redux-thunk
